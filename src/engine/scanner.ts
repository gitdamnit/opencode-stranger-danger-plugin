...
function makeRedactionToken(ruleId: string, value: string): string {
 ...
 */
export function scan(content: string, source: Finding["source"], filePath?: string): Finding[] {
 ...
 */
export function redact(content: string, findings: Finding[]): string {
...
export function scanAndRedact(
    ...
    filePath?: string,
): { redacted: string; findings: Finding[] } {
